...
CREATE TABLE IF NOT EXISTS `file_shares` (
    ...
    `allow_download` TINYINT(1) NOT NULL DEFAULT 1 COMMENT 'Allow download vs view-only',
    `password_hash` VARCHAR(255) NULL COMMENT 'Optional argon2 password hash for link',
